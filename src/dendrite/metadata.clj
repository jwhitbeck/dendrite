...
(defrecord ColumnChunkMetadata [bytes num-data-pages data-page-offset dictionary-page-offset])

(defrecord RecordGroupMetadata [bytes num-records column-chunks-metadata])
